  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Analytics Dashboard</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              ...
              <p className="text-xl sm:text-2xl font-semibold text-gray-900">{summary.total_bills}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              ...
              <p className="text-xl sm:text-2xl font-semibold text-gray-900">{formatCurrency(summary.total_spent)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              <p className="text-xs sm:text-sm font-medium text-gray-600">Average Bill</p>
              <p className="text-xl sm:text-2xl font-semibold text-gray-900">{formatCurrency(summary.average_bill)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              <p className="text-xs sm:text-sm font-medium text-gray-600">Highest Bill</p>
              <p className="text-xl sm:text-2xl font-semibold text-gray-900">{formatCurrency(summary.highest_bill)}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {comparison && (
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Monthly Comparison</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            <div className="text-center">
              <p className="text-sm font-medium text-gray-600">Current Month</p>
              <p className="text-xl sm:text-2xl font-semibold text-gray-900">{formatCurrency(comparison.current_month.total_spent)}</p>
            </div>
            <div className="text-center">
              <p className="text-sm font-medium text-gray-600">Previous Month</p>
              <p className="text-xl sm:text-2xl font-semibold text-gray-900">{formatCurrency(comparison.previous_month.total_spent)}</p>
            </div>
            <div className="text-center">
              <p className="text-sm font-medium text-gray-600">Change</p>
              <p className={`text-xl sm:text-2xl font-semibold ${comparison.change.percentage >= 0 ? 'text-red-500' : 'text-green-500'}`}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
        ...
        {/* Top Merchants */}
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Top Merchants</h2>
          <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8">
        {/* Payment Categories */}
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Spending by Category</h2>
          <div className="space-y-4">
